 ...
 */
public class QuickPickerZero extends LinearLayout {
    ...
    public QuickPickerZero(Context context) {
        super(context);
    ...
    public QuickPickerZero(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        init(context, attrs);
    }

    public QuickPickerZero(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
        init(context, attrs);
    }
    /**
    ...
    public interface OnQuantityChangeListener {
         ...
         * @param inc_dec
         */
        void onValueChanged(int quantity, View v, String inc_dec);
    }
    ...
    public void setQuantity() {
        String s=mTextViewQuantity.getText().toString();
    ...
    OnClickListener clickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (onQuantityChangeListener != null) {
                onQuantityChangeListener.onValueChanged(getQuantity(),v,inc_dec);
            }
        }
