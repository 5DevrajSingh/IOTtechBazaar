...
public class CircleAnimationUtil {
    ...
    private com.androidproject.iottechbazaar.util.CircleImageView mImageView;
    ...
    private boolean prepare() {
        if (mContextReference.get() != null) {
            ...
            if (mImageView == null)
                mImageView = new com.androidproject.iottechbazaar.util.CircleImageView(mContextReference.get());
